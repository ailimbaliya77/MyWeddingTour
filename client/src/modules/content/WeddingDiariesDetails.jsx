...
const WeddingDiaryDetail = () => {
  ...
  if (!post) return <div className="max-w-3xl mx-auto px-4 py-12 text-gray-500">Story not found.</div>;

  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <Link to="/diaries" className="inline-flex items-center gap-1.5 text-sm text-teal-700 mb-6 hover:underline">
        <ArrowLeft className="w-4 h-4" /> Back to Wedding Diaries
      </Link>
...
export default WeddingDiaryDetail;